			...
			<div>
				...
				<ul>
					...
					<li>
						...
						is used by those looking for prospective roommates for the upcoming
						academic year.
					</li>
					<li>
						The{" "}
						...
						is used by those looking to donate to our MSA. The Vanderbilt Muslim
						Students Association is a small but thriving community of young
						Muslims aspiring to work on their faith and grow together. Donations
						such as these contribute to our community life by helping to fund
						our halaqas, masjid outings, prayer space renovations, and Ramadan
						planning. We appreciate every dollar and will work to ensure it is
						put towards worthwhile causes. May Allah swt bless you and your
						family. Thank you!
					</li>
				</ul>
			</div>
